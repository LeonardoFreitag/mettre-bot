...
server.listen(port, function () {
    ...
    console.log('Para iniciar ' + process.env.PROTOCOL + '://localhost:' + port + '/session/12345678?auth=' + secret);
    console.log('Para iniciar ' + process.env.PROTOCOL + '://localhost:' + port + '/session-qr/12345678?auth=' + secret);
});
